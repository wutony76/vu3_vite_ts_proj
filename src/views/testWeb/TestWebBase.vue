      ...
      <div class="explore-content">
        <div class="row">
          <div class=" col-md-4 col-sm-6">
            <div class="single-explore-item">
              <div class="single-explore-img">
                <!-- {{ globe.img1 }} -->
                <img :src="globe.img1" alt="explore image">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="single-explore-item">
              <div class="single-explore-img">
                <img :src="globe.img2" alt="explore image">
                <div class="single-explore-img-info">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="single-explore-item">
              <div class="single-explore-img">
                <img :src="globe.img3" alt="explore image">
                <div class="single-explore-img-info">
                  <button onclick="window.location.href='#'">best rated</button>
                  <div class="single-explore-image-icon-box">
                    <ul>
          ...
          <div class=" col-md-4 col-sm-6">
            <div class="single-explore-item">
              <div class="single-explore-img">
                <img :src="globe.img4" alt="explore image">
                <div class="single-explore-img-info">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="single-explore-item">
              <div class="single-explore-img">
                <img :src="globe.img5" alt="explore image">
                <div class="single-explore-img-info">
                  <button onclick="window.location.href='#'">featured</button>
                  <div class="single-explore-image-icon-box">
                    <ul>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="single-explore-item">
              <div class="single-explore-img">
                <img :src="globe.img6" alt="explore image">
                <div class="single-explore-img-info">
                  <button onclick="window.location.href='#'">best rated</button>
                  <div class="single-explore-image-icon-box">
                    <ul>
...
<script setup lang="ts">
  // import {ref} from 'vue'
  // import Test from '../testWeb/components/test.vue'
  import navbar from '@/components/testWeb/navbar.vue'
  ...
  const globe: urlPath = {
    img1: new URL('@/assets/images/explore/e1.jpg', import.meta.url),
    img2: new URL('@/assets/images/explore/e2.jpg', import.meta.url),
    img3: new URL('@/assets/images/explore/e3.jpg', import.meta.url),
    img4: new URL('@/assets/images/explore/e4.jpg', import.meta.url),
    img5: new URL('@/assets/images/explore/e5.jpg', import.meta.url),
    img6: new URL('@/assets/images/explore/e6.jpg', import.meta.url)
  }
</script>